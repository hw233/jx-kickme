...
function LastDamage(NpcIndex)
	if(SubWorld == SubWorldID2Idx(380)) then
		...
		SetPMParam(1,nPlayerDataIdx,8,GetPMParam(1,nPlayerDataIdx,8) + TICHLUY_GIETNPC*5);--tich luy npc,
		local nTotalAccum = GetPMParam(1,nPlayerDataIdx,2) +TICHLUY_GIETNPC*5;--tong so tich luy
