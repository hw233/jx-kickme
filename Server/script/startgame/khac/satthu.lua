...
function addnpcsatthu()
	...
	--     5,"Gia C¸t Kinh Hång",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)
	--SetNpcValue(nNpcIndex, 1); --con 1
	--
	--nNpcIndex = AddNpcNew(811,100,224,(236*8)*32,(185*16)*32,DEATHFILEST, --co thu dang
	--     5,"Cæ Thñ §»ng",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)
	...
	--     5,"VÖ Biªn Thµnh",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)
	...
	nNpcIndex = AddNpcNew(814,100,321,47900,87972,DEATHFILEST,
	     5,"Liªn H×nh Th¸i",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	SetNpcValue(nNpcIndex, 4);
	--==============Sa Mac=================
	...
	nNpcIndex = AddNpcNew(818,100,225,45648,99316,DEATHFILEST,
	     5,"Hµ Sinh Vong",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	SetNpcValue(nNpcIndex, 8);
	--==============Tien cuc dong=================
	nNpcIndex = AddNpcNew(768,100,93,52736,105030,DEATHFILEST,
	     5,"Gi¶ Giíi Nh©n",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	SetNpcValue(nNpcIndex, 9);
	
	nNpcIndex = AddNpcNew(812,100,93,52604,97844,DEATHFILEST,
	     5,"TrÞnh Cöu NhËt",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	SetNpcValue(nNpcIndex, 10);
	
	nNpcIndex = AddNpcNew(813,100,93,55614,102490,DEATHFILEST,
	     5,"Chu Së B¸ ",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	...
	nNpcIndex = AddNpcNew(819,100,75,54544,101848,DEATHFILEST,
	     5,"T¨ng ChØ O¸n",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	...
	nNpcIndex = AddNpcNew(768,100,75,58241,102484,DEATHFILEST,
	     5,"Cè Thñ §»ng",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	...
	nNpcIndex = AddNpcNew(817,100,340,39137,87692,DEATHFILEST,
	     5,"Trö Thiªn MÉn",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	SetNpcValue(nNpcIndex, 17);
	
	nNpcIndex = AddNpcNew(820,100,340,55493,88554,DEATHFILEST,
	     5,"§o¹n L¨ng NguyÖt",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	SetNpcValue(nNpcIndex, 18);
	
	nNpcIndex = AddNpcNew(818,100,340,61636,88584,DEATHFILEST,
	     5,"NhËm Th­¬ng Khung",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
	SetNpcValue(nNpcIndex, 19);
	
	nNpcIndex = AddNpcNew(819,100,340,40792,87600,DEATHFILEST,
	     5,"T¶ DËt Minh",1,"555",0,500000,100,8000,nil,10,20,nil,2000,50,2,DROPFILEST)	
