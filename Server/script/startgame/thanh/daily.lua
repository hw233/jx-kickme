...
function addnpcdaily()
	...
	----NPC Chuc nang-----
    nNpcIdx = AddNpcNew(244,1,162,1536*32,3200*32,"\\script\\global\\npcchucnang\\taphoa.lua",6,84);SetNpcValue(nNpcIdx, 17);
   ...
   --=====NPC daily======
    ...
    AddNpcNew(287,1,162,1648*32,3142*32,"\\script\\npcthanhthi\\daily\\thantoan.lua",6,36)	
	...
	AddNpcNew(329,1,162,1579*32,3154*32,"\\script\\npcthanhthi\\daily\\tetuu.lua",6,"TÕ töu") 
