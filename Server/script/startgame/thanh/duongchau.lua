...
function addnpcduongchau()
	local nNpcIdx;
	--Nhim , heo rung  11,12		
	AddNpcAuto(3,247,188,{11,33,34,12},20,80,240,181,DEATHFILE1X,
		5,nil,1,"555",nil,nil,nil,50,10,15,20,nil,600,nil,nil,DROPFILE1X);
	AddNpcAuto(3,229,209,{11,33,34,12},20,80,220,204,DEATHFILE1X,
		5,nil,1,"555",nil,nil,nil,50,10,15,20,nil,600,nil,nil,DROPFILE1X);
	AddNpcAuto(3,194,207,{11,33,34,12},20,80,186,202,DEATHFILE1X,
		5,nil,1,"555",nil,nil,nil,50,10,15,20,nil,600,nil,nil,DROPFILE1X);
	AddNpcAuto(3,202,184,{11,33,34,12},20,80,195,180,DEATHFILE1X,
		5,nil,1,"555",nil,nil,nil,50,10,15,20,nil,600,nil,nil,DROPFILE1X);
	...
	--AddNpcNew(309,1,80,1628*32,3207*32,"\\script\\global\\npcchucnang\\congbinhtu.lua",6,868)
	--AddNpcNew(309,1,80,1710*32,3250*32,"\\script\\global\\npcchucnang\\congbinhtu.lua",6,868)
	--AddNpcNew(309,1,80,1852*32,3049*32,"\\script\\global\\npcchucnang\\congbinhtu.lua",6,868)
	--AddNpcNew(309,1,80,1659*32,3021*32,"\\script\\global\\npcchucnang\\congbinhtu.lua",6,868)	
	...
	AddNpcNew(329,1,80,1765*32,3013*32,"\\script\\npcthanhthi\\duongchau\\tetuu.lua",6,"TÕ Töu")	
    AddNpcNew(385,1,80,1791*32,3094*32,"\\script\\npcthanhthi\\duongchau\\chucamdo.lua",6,808)	
	...
	AddNpcNew(286,1,80,1830*32,3132*32,"\\script\\npcthanhthi\\duongchau\\trandailuc.lua",6,36)
...
function addobjduongchau()
	AddObj(4,80,1602*32,3216*32,"\\script\\maps\\duongchau\\obj\\caothi.lua")		
	AddObj(4,80,1868*32,3037*32,"\\script\\maps\\duongchau\\obj\\caothi.lua")
	AddObj(4,80,1668*32,3010*32,"\\script\\maps\\duongchau\\obj\\caothi.lua")	
	AddObj(3,80,1590*32,2994*32,"\\script\\maps\\duongchau\\obj\\caothi.lua")
	AddObj(3,80,1761*32,3009*32,"\\script\\maps\\duongchau\\obj\\caothi.lua",2)
	AddObj(296,92,1634*32,3277*32,"\\script\\maps\\duongchau\\obj\\thuccuongson.lua",2)
end;
