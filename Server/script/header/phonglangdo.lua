...
function release_npcphonglang()
	...
	nNpcIdx = AddNpcNew(724,100,337,NPC_PHONGLANG[i][1],NPC_PHONGLANG[i][2],DIE_PHONGLANG,nil,nil,
		1,"555",5000*EXP_RATE,50000,nil,300,50,50,55,nil,1400,25,nil,DROP_PHONGLANG);
		if(nNpcIdx > 0) then
		AddMSNpc(1,nNpcIdx);
		end
	end
...
function release_phonglangboss()
	...
	nil,"Thñy tÆc ®Çu lÜnh",1,"555",150000*EXP_RATE,1000000,nil,500,80,50,55,nil,12*1080,50,2,DROP_PHONGLANG);
	if(nNpcIdx > 0) then
		AddMSNpc(1,nNpcIdx);
	end
	end
